...
export const metadata: Metadata = {
  ...
  description: "Join AUI Discord - India's most active Discord server with 70,000+ members! Among US India Discord community for gaming, tournaments, events, and fun. Best Indian gaming Discord server with 24/7 music, Valorant, Minecraft, BGMI & more.",
  ...
  openGraph: {
    ...
    description: "Join All AUI Discord - India's most active Discord server with 70,000+ members! Among US India Discord community for gaming, tournaments, events, and fun. Best Indian gaming Discord server with 24/7 music, Valorant, Minecraft, BGMI & more.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${geistSans.variable} ${geistMono.variable} ${poppins.className} antialiased bg-zinc-50 dark:bg-black`}>
        <ThemeProvider
          attribute="class"
          defaultTheme="dark"
