    ...
    <main className="container mx-auto px-12 lg:px-24 py-8">
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <p className="text-base text-muted-foreground">
            With over 70,000+ members and counting, we provide a space where gamers, content creators, and friends come together to connect, play, and build lasting relationships in a safe and engaging environment.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="space-y-3">
            <ul className="list-disc pl-6 space-y-2 text-base text-muted-foreground">
              <li>Grown to 70,000+ active members across India</li>
